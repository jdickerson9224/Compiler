...
if (isset($_POST['submit']))
{
	...
	$sql="Insert into `documentManagement` (`fileName`,`directory`,`uploadBy`,`dateCreated`,`status`,`fileType`,`content`) values ('$fileName','$path','$uploadBy','$uploadDate','active','$docType','$contentsClean')";
	$dblink->query($sql) or
